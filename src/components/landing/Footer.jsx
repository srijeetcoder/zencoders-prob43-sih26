      ...
      <div className="container-page">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-12 pb-12 border-b border-line">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className={`${large ? 'text-sm' : 'text-xs'} text-ink-2 space-y-2`}>
              <li>
                <Link to="/register?role=citizen" className="hover:text-accent transition-colors">
                  For Citizens
                </Link>
              </li>
              <li>
                <Link to="/register?role=panchayat" className="hover:text-accent transition-colors">
                  Gram Panchayats
                </Link>
              </li>
              <li>
                <Link to="/register?role=ministry" className="hover:text-accent transition-colors">
                  State Ministries
                </Link>
              </li>
              <li>
                <Link to="/register?role=university" className="hover:text-accent transition-colors">
                  University Labs
                </Link>
              </li>
              <li>
                <Link to="/register?role=industry" className="hover:text-accent transition-colors">
                  Industry & CSR
                </Link>
              </li>
            </ul>
