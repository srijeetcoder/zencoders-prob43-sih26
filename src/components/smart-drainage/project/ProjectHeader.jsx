...
import { projectInfo } from "../../../data/smartDrainageData";

export default function ProjectHeader() {
  return (
    <div>
      <div className="flex items-center gap-2 text-[13px] text-gray-500 mb-3">
        <Link to="/" className="hover:text-[#1a5c5a] cursor-pointer">Home</Link>
        <ChevronRight size={12} />
        <Link to="/gov-dashboard" className="hover:text-[#1a5c5a] cursor-pointer">Projects</Link>
        <ChevronRight size={12} />
      ...
      <div className="flex items-start justify-between mb-5">
        <div className="flex items-start gap-2">
          <Link to="/gov-dashboard" className="text-[13px] text-gray-500 hover:text-gray-800 flex items-center gap-1 mt-0.5">
