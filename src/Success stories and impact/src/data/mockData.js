...
export const featuredStory = {
  ...
  description:
    "Residents of Purulia faced severe water contamination during monsoon season. Through collaboration between the local administration, IIT Kharagpur and an industry partner, a low-cost, solar-powered water purification system was deployed, providing clean drinking water to over 12,000 people.",
  partners: [
  ...
  impact: [
    { value: "12,000+", label: "People Benefited", icon: "users" },
    { value: "70%", label: "Reduction in Waterborne Diseases", icon: "shield" },
    { value: "6 Months", label: "From Proposal to Deployment", icon: "clock" },
    { value: "₹1.2 Cr", label: "Total Project Cost", icon: "indianRupee" },
  ],
};
...
export const keyHighlights = [
  { value: "12.5 Million", label: "Lives Improved", icon: "users" },
  { value: "1,240", label: "Solutions Implemented", icon: "layers" },
  { value: "680+", label: "Districts Reached", icon: "mapPin" },
  { value: "3.2x", label: "Average Cost Savings", icon: "trendingUp" },
];
